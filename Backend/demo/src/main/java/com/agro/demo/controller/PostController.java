...
public class PostController {
    ...
    public ResponseEntity<?> updatePost(
        ...
        logger.info("Content: {}, Caption: {}, Images: {}, Video: {}", 
            content, caption, images != null ? images.size() : 0, video != null ? video.getOriginalFilename() : "none");
        ...
        try {
            ...
            if (caption != null) {
                ...
                updatedPost.setCaption(existingPost.getCaption());
            }
            ...
            if (images != null && !images.isEmpty()) {
                ...
                updatedPost.setImageUrls(existingPost.getImageUrls());
            }
            ...
            Post post = postService.updatePost(id, userId, updatedPost, video);
            return ResponseEntity.ok(post);
        } catch (IllegalArgumentException e) {
            logger.error("Validation error: {}", e.getMessage());
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(e.getMessage());
